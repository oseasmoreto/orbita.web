    ...
    products: {
      ...
      form: {
        ...
        errors: {
          ...
          nameRequired: 'Nome é obrigatório.',
          shippingCostMin: 'Custos de envio não pode ser negativo.',
  ...
  identity: {
    ...
    companyRegistration: {
      ...
      errors: {
        ...
        nameRequired: 'Nome é obrigatório.',
        operationalCostPercentageMax: 'Custo operacional não pode passar de 100%.',
        operationalCostPercentageMin: 'Custo operacional não pode ser negativo.',
      ...
      fields: {
        ...
        operationalCostPercentage: 'Custo operacional (%)',
      ...
      operationalCostPercentageTooltip:
        'Percentual de custo operacional do seu negócio — entra no cálculo de precificação, deduzido do lucro. Mesmo valor pra toda a empresa, não varia por canal.',
      placeholders: {
      ...
      taxRegimePlaceholder: 'Selecione o regime tributário',
      taxRegimeWarning:
        'Campo só informativo. Empresas com porte maior que os listados aqui (ex.: Lucro Presumido, Lucro Real) ainda não são suportadas pela plataforma.',
