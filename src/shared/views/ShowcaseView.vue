...
// Vitrine dos componentes de UI já implementados
// (docs/design/catalogo-componentes.md) — galeria de referência/teste
// visual, movida pra rota própria (`/showcase`) em 2026-08-28 quando o
// dashboard de verdade (HomeView.vue) tomou o lugar dela na rota `home`.
// Continua existindo de propósito: é a superfície usada pra verificar
// cada fix pixel-perfect deste projeto, não um artefato descartável.
  ...
  <main class="showcase">
    <header class="showcase__intro">
      ...
      <p>
        ...
        fluxo real do app (não aparece na sidebar).
      </p>
    </header>
